...
function renderBgaLink ({
	id,
	uri
})
{
	return `<a href="${uri}" target="_blank" class="game__bga">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="75 0 960 960">
			<title>
				Available to play on Board Game Arena
			</title>
			<defs>
				<linearGradient id="${id}-gradient" x1="25.953" x2="993.953" y1="927.172" y2="-140.828" gradientUnits="userSpaceOnUse">
